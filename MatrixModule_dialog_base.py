...
#
# Created: Tue Apr 14 09:08:18 2015
...
class Ui_MatrixElaboratorDialogBase(object):
    def setupUi(self, MatrixElaboratorDialogBase):
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(20, 120, 561, 31))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(20, 160, 561, 31))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(20, 200, 561, 31))
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(20, 240, 561, 31))
        ...
        self.groupBox_6.setGeometry(QtCore.QRect(20, 280, 561, 31))
        ...
        self.b1.setGeometry(QtCore.QRect(530, 80, 51, 32))
        self.b1.setObjectName(_fromUtf8("b1"))
        self.label_7 = QtGui.QLabel(MatrixElaboratorDialogBase)
        self.label_7.setGeometry(QtCore.QRect(210, 30, 131, 20))
    ...
    def retranslateUi(self, MatrixElaboratorDialogBase):
        ...
        self.label.setText(_translate("MatrixElaboratorDialogBase", "R", None))
        self.label_2.setText(_translate("MatrixElaboratorDialogBase", "K", None))
        self.b2.setText(_translate("MatrixElaboratorDialogBase", "...", None))
        self.label_3.setText(_translate("MatrixElaboratorDialogBase", "L", None))
        self.b3.setText(_translate("MatrixElaboratorDialogBase", "...", None))
        self.label_4.setText(_translate("MatrixElaboratorDialogBase", "S", None))
        self.b4.setText(_translate("MatrixElaboratorDialogBase", "...", None))
        self.label_5.setText(_translate("MatrixElaboratorDialogBase", "C", None))
        self.b5.setText(_translate("MatrixElaboratorDialogBase", "...", None))
        self.label_6.setText(_translate("MatrixElaboratorDialogBase", "P", None))
        self.b6.setText(_translate("MatrixElaboratorDialogBase", "...", None))
        self.b1.setText(_translate("MatrixElaboratorDialogBase", "...", None))
        self.label_7.setText(_translate("MatrixElaboratorDialogBase", "A = R * K * L*S * C * P", None))
